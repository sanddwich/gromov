    ...
    return (
      <Container className="Block11 p-0">
        ...
        <Row className="Block11__Row m-0 p-0">
          ...
          <Col md={6} className="Block11__Right p-0 d-none d-md-flex align-items-center"><img src="img/block11_1.png" alt=""/></Col>
          <Col xs={12} className="Block11__RightMob p-0 d-flex d-md-none"><img className="img-fluid" src="img/block11_1.png" alt=""/></Col>
        </Row>
      </Container>
    )
  }
