...
if ($url !== '') {
    ...
    $message = $message . '<p>Ссылка для скачивания программы: ' . $url . '</p>';
} else {
    $message = $message . '<p> Свяжитесь со мной по тел. +79171874086 для дальнейшей работы. Доступен в Whatsapp.</p>';
}
